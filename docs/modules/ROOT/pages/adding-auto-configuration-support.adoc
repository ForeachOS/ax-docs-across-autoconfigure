...
[[acrosscontextinfraprocessormodule]]
== AcrossContextInfrastructureModule
Every Across context contains a placeholder module called *AcrossContextInfrastructureModule*.
It usually starts as the very first module.
It can be used as an extension point to move configuration classes to that need to be available for all other modules.
